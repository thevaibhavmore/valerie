                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li><i class="fa fa-map-marker"></i>Bells Demo Store, Demo store
                                        India 345-659</li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> 2020 valerie Vuitton Developed by
                                Trendy Minds</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="assets/images/christmas/pro3/1.jpg" alt=""
