...
<body class="christmas " style="background-image:url('assets/images/christmas/bg.jpg');background-size:cover;background-repeat:none;">
    <!-- pre-loader start -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 text-right">
                        <ul class="header-dropdown">
                            <li class="mobile-wishlist"><a href="#" title="wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                            </li>
                        ...
                        <div style="margin: 0 auto;">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <li class="menu-itm">
                                        <a href="index.php"><?php echo utf8_encode('Über Mich'); ?></a>
                                        
                                    </li>
                                    <li class="menu-itm">
                                        <a href="javascript:;"><?php echo utf8_encode('Photo Gallery'); ?></a>
                                        
                                    </li>
                                    <li class="menu-itm">
                                        <a href="javascript:;"><?php echo utf8_encode('Shop'); ?></a>
                                    ...
                                    <li class="menu-itm">
                                        <a href="javascript:;"><?php echo utf8_encode('Aktionen'); ?></a>
                                        
                                    </li>
                                    
                                    <li class="menu-itm">
                                        <a href="javascript:;"><?php echo utf8_encode('Buch Mich'); ?></a>
                                        
                                    </li>
                                    
                                    <li class="menu-itm">
                                        <a href="javascript:;"><?php echo utf8_encode('Kontakt'); ?></a>
